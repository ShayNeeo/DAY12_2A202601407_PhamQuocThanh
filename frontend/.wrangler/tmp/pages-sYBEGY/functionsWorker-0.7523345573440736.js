...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.16.1_unenv@2.0.0-rc.24_workerd@1.20260801.1/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.16.1_unenv@2.0.0-rc.24_workerd@1.20260801.1/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../node_modules/.pnpm/wrangler@4.119.0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.16.1_unenv@2.0.0-rc.24_workerd@1.20260801.1/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../node_modules/.pnpm/wrangler@4.119.0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
var GUARDS_INSTRUCTION = `You are a helpful customer service assistant for VinBank.
...
__name(detectInjection, "detectInjection");
function checkSecretLeak(response) {
...
__name(checkSecretLeak, "checkSecretLeak");
...
async function onRequestPost(context2) {
  try {
    ...
    const apiKey = context2.env.GOOGLE_API_KEY;
    if (!apiKey) {
      return new Response(
...
${responseText}`
        ...
        if (judgeRes.ok) {
          ...
          const judgeVerdict = judgeData.candidates?.[0]?.content?.parts?.[0]?.text || "";
          if (judgeVerdict.toUpperCase().includes("UNSAFE")) {
            judgeSafe = false;
            responseText = "I cannot share internal system details. How else can I help with your VinBank account or banking needs?";
          }
        }
      } catch (e) {
      }
...
// ../.wrangler/tmp/pages-sYBEGY/functionsRoutes-0.6293227516296982.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// ../node_modules/.pnpm/wrangler@4.119.0/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
